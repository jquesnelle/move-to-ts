...
pub fn generate_topmost_index(packages: &[&String], is_async: bool) -> (String, String) {
    ...
    let content = format!(
        r###"
import {{ AptosClient }} from "aptos";
import {{ AptosParserRepo, AptosLocalCache, AptosSyncedCache, u8, u64, u128, numbersOrStringToHexString }} from "@manahippo/move-to-ts";
{}
{}
export {{ u8, u64, u128, numbersOrStringToHexString }};
